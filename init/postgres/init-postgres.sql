...
INSERT INTO classes (type, title, requirements, date, duration, course_id) VALUES
  ('Лекция',       'Введение в программирование',               'Установленный Python (3.8+)',              '2023-09-01',  90, 1),
  ('Семинар',      'ООП – практика',                           'Установленный Python (3.8+)',                 '2023-09-05', 120, 2),
  ('Лекция',       'Основы баз данных',                        'SQL-клиент (psql, DBeaver) и доступ к PostgreSQL',                      '2023-09-10',  90, 3),
  ('Лабораторная', 'Экономическая теория – задачи',            'Калькулятор (реальный или в приложении), ноутбук для выгрузки отчётов', '2023-09-15', 120, 4),
  ('Лекция',       'Введение в менеджмент',                    'Проектор и презентация в PowerPoint, ноутбук для конспектирования',      '2023-09-20',  90, 5),
  ('Семинар',      'Практика по дискретной математике',        'Тетрадь, ручка и калькулятор; для демонстрации – экран с интерактивной доской', '2023-09-25', 120, 6),
  ('Лекция',       'Основы физики',                             'Учебник по физике, калькулятор; доступ к виртуальному лабораторному стенду',      '2023-10-01',  90, 7),
  ('Лекция',       'Органическая химия – введение',             'Лаборантский халат, защитные очки, перчатки; рабочая станция с ChemSketch',      '2023-10-05',  90, 8),
  ('Семинар',      'Биология клетки – структура',               'Микроскоп или виртуальный эмулятор микроскопа, ноутбук',                '2023-10-10', 120, 9),
  ('Лекция',       'Статистика: основы',                         'Ноутбук с установленным R и RStudio или Excel; доступ к набору тестовых данных', '2023-10-15',  90,10);
